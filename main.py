...
# executing the code starts with the nested function "What is your name" before moving to the outer brackets
#Refer to Thonny IDE for a step-by-step breakdown 

#SUMMARY
# input() will get user input inconsole
# then print() will print word "Hello" and the user input
